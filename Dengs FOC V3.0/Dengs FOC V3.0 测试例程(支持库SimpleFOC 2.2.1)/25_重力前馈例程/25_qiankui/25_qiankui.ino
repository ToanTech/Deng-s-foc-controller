/**
Deng's FOC M0 FOC电流控制例程 适用于SimpleFOC Studio 测试库：SimpleFOC 2.1.1 测试硬件：灯哥开源FOC V3.0
在串口窗口中输入：M+电流，就可以使得M0电机闭环转动，电流单位为A
setup()中可取消注释设置电压限制与电流限制
在使用自己的电机时，请一定记得修改默认极对数，即 BLDCMotor(14) 中的值，设置为自己的极对数数字
程序默认设置的供电电压为 24V,用其他电压供电请记得修改 voltage_power_supply , voltage_limit 变量中的值
